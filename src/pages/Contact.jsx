    ...
    <div>
      ...
      <div className="flex flex-col justify-center gap-10 my-10 md:flex-row mb-28">
        ...
        <div className="flex flex-col items-start justify-center gap-6">
          <p className="text-xl font-semibold text-gray-600">আমাদের স্টোর</p>
          <p className="text-gray-500">
            অফার বাজার ছাগলনাইয়া <br />
            ভূঁঞা মার্কেট (২য় তলা), ছাগলনাইয়া, ফেনী।
          </p>
          <p className="text-gray-500">
            Tel: 01706-003 243, 01829- 062 636 <br />
            Email: offerbazarchhagalnaiya@gmail.com
          </p>
          <p className="text-xl font-semibold text-gray-600">
            আমরা চাই গ্রাহক আমাদের পণ্যের ওপর সন্তুষ্ট হয়ে অন্য মানুষের কাছে
            আমাদের প্রশংসা করুক এবং আমাদের এগিয়ে যাওয়ার পথকে প্রসস্থ করুক।
          </p>
